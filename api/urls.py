...
from .views import (
    ...
    TeacherUpdateAPIView, TeacherDestroyAPIView,TeacherRetrieveAPIView,HomeworkViewListCreateAPIView,HomeworkRetrieveAPIView,
...
urlpatterns = [
    ...
    path("course/<int:pk>/open/",CourseOpenUpdateView.as_view()),
    path("my_course/",MyCourseViewSet.as_view()),
